...
\newcommand*\titel{Presentation Beamer} % On titelpage and in footer on every page
\newcommand*\subkop{TU Presentation template} % In blue color
\newcommand*\naam{Name presentor}
\newcommand*\afdeling{Department}

%>>> If you want to have a navigation bar inside the pdf, you can uncomment the following.
%>>> Personally I prefer to make my pdf client handle navigation
...
{\vfill
\rlap{%\hskip0.1cm
\includegraphics[scale=0.33]{TUDelft/beamer-tudelft-bies} 
}
\vskip-5pt}
%==============================================================
...
\begin{frame}\frametitle{\textbf{\LARGE{\textrm{Page 1}}}}
\end{frame}

\begin{frame}\frametitle{\textbf{\LARGE{\textrm{Page 2}}}}
\end{frame}

\begin{frame}\frametitle{\textbf{\LARGE{\textrm{Last pagina}}}}
\end{frame}
