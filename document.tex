...
\newcommand*\titel{Presentatie Beamer} % On titelpage and in footer on every page
\newcommand*\subkop{TU Huisstijl} % In blue color
\newcommand*\naam{Naam presentator}
...
\includegraphics[scale=0.33]{TUDelft/beamer-tudelft-bies_improved.png} 
}
\vskip-5pt}
%==============================================================
...
\begin{frame}\frametitle{\textbf{\LARGE{\textrm{Pagina 1}}}}
\end{frame}

\begin{frame}\frametitle{\textbf{\LARGE{\textrm{Pagina 2}}}}
\end{frame}

\begin{frame}\frametitle{\textbf{\LARGE{\textrm{Laatste pagina}}}}
\end{frame}
